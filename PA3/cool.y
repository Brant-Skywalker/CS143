...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    %right IN_PREC  /* Fictitious terminal symbol. For context-dependent precedence. */
    %right NOT
    %right ASSIGN
    %nonassoc LE '<' '='
    %left '+' '-'
    ...
    */
    ...
    feature: OBJECTID ':' TYPEID assign {
        $$ = attr($1, $3, $4);
    }
    ...
    | cases case ';'    { $$ = append_Cases($1, single_Cases($2)); }
    ;
